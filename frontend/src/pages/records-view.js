...
import { DataGrid, GridToolbarContainer, GridToolbarColumnsButton, GridToolbarFilterButton, 
...
export default function RecordsView() {
    ...
    return (
        <>
        <Box sx={{ display: "flex", width: "80%", height: "100%", justifyContent: "center", alignItems: "center", m: "auto auto" }}>
        ...
        <Button startIcon={<VisibilityIcon />} onClick={() => alert(JSON.stringify(selectionModel))}>
            Visualise Selection
        </Button>}
        </>
    );
