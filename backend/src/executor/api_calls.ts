...
export async function addExecution(execution: ExecutionDB): Promise<string> {
  try {
...
export async function getLastExecutionForWebsiteRecord(
  ...
  try {
    console.log(
      `Worker thread fetching last execution for website record with id ${id}...`
    );
...
export async function getExecutionsForWebsiteRecord(
  ...
  try {
    console.log(
      `Worker thread fetching executions for website record with id ${id}...`
    );
